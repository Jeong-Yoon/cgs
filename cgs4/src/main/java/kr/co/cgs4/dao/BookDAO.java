...
public class BookDAO {
	...
	public ArrayList<ScreeningInfo> screening_date(){
		String query = "select sc.SCREENING_ID, film_name, site_name, sc.screening_date, sc.screen_num, start_time, seating_cnt from SCREENING sc, site,screen, film where sc.film_id=film.film_id and sc.SITE_ID = site.SITE_ID and site.site_id=screen.site_id group by sc.SCREENING_ID, film_name, site_name, sc.screening_date, sc.screen_num, start_time, seating_cnt order by sc.SCREENING_ID";
