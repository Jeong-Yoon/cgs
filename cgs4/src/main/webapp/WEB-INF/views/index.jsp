...
Start doing.'><img alt=''
		...
		<h2 id='target' class="page-heading heading--outcontainer">Now in
			the cinema</h2>
					...
					<div class="row">
						<div class="social-group">
							...
							<div class="social-group__content">
								A lot of fun, discussions, queezes and contests among members. <br
									class="hidden-xs"> <br>Always be first to know about
								best offers from cinemas and our partners
							</div>
		...
		<!--             <div class="col-sm-12"> --> <!--                 <h2 class="page-heading">Latest news</h2> -->

		<!--                 <div class="col-sm-4 similar-wrap col--remove"> -->
		<!--                     <div class="post post--preview post--preview--wide"> -->
		<!--                         <div class="post__image"> --> <!--                             <img alt='' src="http://placehold.it/270x330"> -->
		...
		<!--                     </div> --> <!--                 </div> --> <!--                 <div class="col-sm-4 similar-wrap col--remove"> -->
		<!--                     <div class="post post--preview post--preview--wide"> -->
		<!--                         <div class="post__image"> --> <!--                             <img alt='' src="http://placehold.it/270x330"> -->
		<!--                             <div class="social social--position social--hide"> -->
		<!--                                 <span class="social__name">Share:</span> -->
