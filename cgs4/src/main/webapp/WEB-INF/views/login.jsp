        ...
        <header class="header-wrapper">
            <div class="container">
                ...
                <div class="control-panel">
                    ...
                    <a href="book1" class="btn btn-md btn--warning btn--book">Book a ticket</a>
                </div>
...
<!--         </div> -->
        ...
        <!-- Main content -->
                <form id="login-form" class="login" method='get' action="loginProcess">
                    <p class="login__title">sign in <br><span class="login-edition">welcome to CGS</span></p>
...
<!--                     <p class="login__tracker">or</p> -->
                    ...
                    <input type='text' placeholder='Member ID' name='user-email' class="login__input" >
